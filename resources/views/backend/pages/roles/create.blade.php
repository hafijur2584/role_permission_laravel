                    ...
                    <form method="POST" action="{{ route('roles.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="" class="form-check-input" id="checkPermissionAll" value="1" />
                            ...
                            @foreach ($groups as $group)
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        id="Management{{$i}}" value="1" onclick="checkPermissionByGroup('role-{{$i}}-management-checkbox', this)" />
